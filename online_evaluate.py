...
# python evaluate.py <annotation-csv-filename> <prediction-csv-filename>
# annotation-csv:
# Study,Atelectasis,Cardiomegaly,Consolidation,Edema,Pleural Effusion
# CheXpert-v1.0/valid/patient00000/study1,0,0,1,0,1
# CheXpert-v1.0/valid/patient00000/study2,0,1,0,0,0
#
# prediction-csv:
# Study,Atelectasis,Cardiomegaly,Consolidation,Edema,Pleural Effusion
