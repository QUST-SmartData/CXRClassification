...
class LKA(nn.Module):
    def __init__(self, dim):
        ...
        self.conv0 = nn.Conv2d(dim, dim, kernel_size=1, stride=1, padding=0, dilation=1, groups=dim)
        self.conv1 = nn.Conv2d(dim, dim, kernel_size=3, stride=1, padding=1, dilation=1, groups=dim)
        self.conv2 = nn.Conv2d(dim, dim, kernel_size=3, stride=1, padding=3, dilation=3, groups=dim)
        self.conv3 = nn.Conv2d(dim, dim, kernel_size=3, stride=1, padding=5, dilation=5, groups=dim)
        self.conv4 = nn.Conv2d(dim, dim, kernel_size=3, stride=1, padding=7, dilation=7, groups=dim)
        self.conv5 = nn.Conv2d(dim, dim, kernel_size=3, stride=1, padding=9, dilation=9, groups=dim)
    ...
    def forward(self, x):
        ...
        attn4 = self.conv4(x)
        attn5 = self.conv5(x)
        attn = attn0 + attn1 + attn2 + attn3 + attn4 + attn5
...
@register_model
def dila_van_b0(pretrained=False, **kwargs):
    model = VAN(
