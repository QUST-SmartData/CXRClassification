...
from timm.models import swin_large_patch4_window7_224
...
class GCNResnet(nn.Module):
    def __init__(self, model, num_classes, t=0.2):
        ...
        self.gc2 = GraphConvolution(1024, 1536)
    ...
    def forward(self, feature):
        ...
        feature = self.pooling(feature.permute(0, 2, 1).view(feature.size(0), -1, 7, 7))
...
def gcn_swin_large_patch4_window7_224(pretrained=False, in_chans=3, num_classes=5, t=0.2):
    model = swin_large_patch4_window7_224(pretrained=pretrained)
    return GCNResnet(model, num_classes, t=t)


if __name__ == '__main__':
    m = gcn_swin_large_patch4_window7_224(num_classes=len(config.class_labels))
